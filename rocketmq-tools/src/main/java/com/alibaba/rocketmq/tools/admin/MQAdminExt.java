...
public interface MQAdminExt extends MQAdmin {
     ...
     * @throws RemotingException
     */
    public void createAndUpdateSubscriptionGroupConfig(final String addr,
     ...
     * @return
     */
    public TopicStatsTable examineTopicStats(final String topic)
     ...
     * @throws MQBrokerException
     */
    public ConsumeStats examineConsumeStats(final String consumerGroup)
            throws RemotingException, MQClientException, InterruptedException, MQBrokerException;
     ...
     * @return
     */
    public TopicRouteData examineTopicRouteInfo(final String topic)
     ...
     * @throws RemotingException
     */
    public KVTable getKVListByNamespace(final String namespace)
            throws RemotingException, MQClientException, InterruptedException;
     ...
     * @throws MQClientException
     */
    public void deleteTopicInBroker(final Set<String> addrs, final String topic)
            throws RemotingException, MQBrokerException, InterruptedException, MQClientException;
     ...
     * @throws MQClientException
     */
    public void deleteSubscriptionGroup(final String addr, String groupName)
            throws RemotingException, MQBrokerException, InterruptedException, MQClientException;
     ...
     * @throws MQClientException
     */
    public void deleteIpsByProjectGroup(String key)
            throws RemotingException, MQBrokerException, InterruptedException, MQClientException;
