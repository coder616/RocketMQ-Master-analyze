            ...
            if ((97 <= chValue && chValue <= 122) || (65 <= chValue && chValue <= 90)
                ...
                if (Type.OPERATOR == preType || Type.SEPAERATOR == preType || Type.NULL == preType
                    ...
                    if (Type.OPERATOR == preType) {
                        segments.add(
                            createOperator(expression.substring(wordStartIndex, wordStartIndex + wordLen)));
                    }
                    wordStartIndex = i;
                    wordLen = 0;
                }
                ...
                if (Type.OPERAND == preType || Type.SEPAERATOR == preType || Type.PARENTHESIS == preType) {
                    if (Type.OPERAND == preType) {
                        segments
                            .add(new Operand(expression.substring(wordStartIndex, wordStartIndex + wordLen)));
                    }
                    wordStartIndex = i;
                    wordLen = 0;
                }
                ...
                throw new IllegalArgumentException(
                    "illegal expression, at index " + i + " " + (char) chValue);
            }
