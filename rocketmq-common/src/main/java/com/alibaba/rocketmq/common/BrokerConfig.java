...
public class BrokerConfig {
     ...
     * （当key值为NULL时,返回def的值；当key值不为NULL时,返回key的值 ）
    ...
    @ImportantField
    private String brokerIP1 = RemotingUtil.getLocalAddress();// 本地ip
    private String brokerIP2 = RemotingUtil.getLocalAddress();
    @ImportantField
    private String brokerName = localHostName();// 默认为主机名或DEFAULT_BROKER
    @ImportantField
    private String brokerClusterName = "DefaultCluster";
    @ImportantField
    private long brokerId = MixAll.MASTER_ID;// 0
