...
public class DefaultMQProducerImpl implements MQProducerInner {
    ...
    // 每个topic对应的发送地址相关信息，往哪个broker发送
    ...
    private SendResult sendDefaultImpl(Message msg, final CommunicationMode communicationMode,
        ...
        this.makeSureStateOK();// 校验服务是否可用
        Validators.checkMessage(msg, this.defaultMQProducer);// 判断消息的有效性
    ...
    public TransactionSendResult sendMessageInTransaction(final Message msg,
        ...
        try {
            ...
            log.warn(
                "local transaction execute " + localTransactionState + ", but end broker transaction failed",
                e);
        }
