            ...
            if (!brokerAddrs.isEmpty()) {
                ...
                for (String addr : brokerAddrs) {
                    try {
                        ...
                        this.mQClientFactory.getMQClientAPIImpl().queryMessage(addr, requestHeader, 1000 * 15,
                            new InvokeCallback() {
                                @Override
                                        ...
                                        if (response != null) {
                                            ...
                                            case ResponseCode.SUCCESS: {
                                                ...
                                                try {
                                                    responseHeader = (QueryMessageResponseHeader) response
                                                        .decodeCommandCustomHeader(
                                                            QueryMessageResponseHeader.class);
                                                }
                                                ...
                                                QueryResult qr = new QueryResult(
                                                    responseHeader.getIndexLastUpdateTimestamp(), wrappers);
