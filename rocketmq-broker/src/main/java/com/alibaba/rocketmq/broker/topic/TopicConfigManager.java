...
public class TopicConfigManager extends ConfigManager {
    ...
    public TopicConfigManager(BrokerController brokerController) {
        ...
        }
        {
            ...
            if (this.brokerController.getBrokerConfig().isAutoCreateTopicEnable()) {
                ...
                this.systemTopicList.add(topic);
                topicConfig
                    .setReadQueueNums(this.brokerController.getBrokerConfig().getDefaultTopicQueueNums());
                topicConfig
                    .setWriteQueueNums(this.brokerController.getBrokerConfig().getDefaultTopicQueueNums());
    ...
    public String configFilePath() {
        return BrokerPathConfigHelper
            .getTopicConfigPath(this.brokerController.getMessageStoreConfig().getStorePathRootDir());
    }
